...
export const designTypes = [{ type: 'CR', icon: 'fas fa-burn', text: 'Cuenta regresiva', tag: 'Nuevo' }, { type: 'POR', icon: 'fas fa-book', text: 'Portada de libro' }, { type: 'BAN', icon: 'far fa-window-restore', text: 'Banner para post' }];
...
export const contributors = ['@Gricardov', '@JennyAline', '@CaroDePearolMorales', '@AlphaPhantom', '@JackDreamer', '@PiccolaScrittrice', '@SayraBaylon'];